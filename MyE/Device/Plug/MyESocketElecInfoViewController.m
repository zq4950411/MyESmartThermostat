//
//  MyESocketElecInfoViewController.m
//  MyE
//
...
#import "MyESocketElecInfoViewController.h"
...
@interface MyESocketElecInfoViewController ()

@end

@implementation MyESocketElecInfoViewController
...
-(void)downloadElecInfoFromServer{
    ...
    [HUD show:YES];
    NSString *str = [NSString stringWithFormat:@"%@?houseId=%li&tId=%@&action=%i",GetRequst(URL_FOR_SOCKET_ELEC_INFO),(long)MainDelegate.houseData.houseId, self.device.tid,self.dateSegment.selectedSegmentIndex+1];
