...
static const CGFloat kHeightOfTopScrollView = 35.0f;//顶部视图的高度
static const CGFloat kWidthOfButtonMargin = 10.0f; //两个button之间的间隔
static const CGFloat kFontSizeOfTabButton = 17.0f;//顶部视图中button的字体大小
...
//    _topScrollView.backgroundColor = [UIColor clearColor];
    _topScrollView.backgroundColor = [UIColor colorWithRed:0.95 green:0.95 blue:0.95 alpha:1];
    _topScrollView.pagingEnabled = NO;
    _topScrollView.showsHorizontalScrollIndicator = NO;
    _topScrollView.showsVerticalScrollIndicator = NO;
    _topScrollView.delaysContentTouches = NO;//这句代码太他妈的重要了
    _topScrollView.autoresizingMask = UIViewAutoresizingFlexibleWidth;
    [self addSubview:_topScrollView];
    _userSelectedChannelID = 100;
    
    //创建主滚动视图
    _rootScrollView = [[UIScrollView alloc] initWithFrame:CGRectMake(0, kHeightOfTopScrollView, self.bounds.size.width, self.bounds.size.height - kHeightOfTopScrollView- 20 - 44)];
    ...
    _rootScrollView.delaysContentTouches = NO;//这句代码太他妈的重要了
...
//            button.selected = YES;
//        }
//    /*-------这里是button的title设置地方，此处为了取巧，所以此处设置了button的title --------*/
