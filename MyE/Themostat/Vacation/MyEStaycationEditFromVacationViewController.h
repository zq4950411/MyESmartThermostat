//
//  MyEStaycationEditFromVacationViewControllerViewController.h
//  MyE
//
...
@interface MyEStaycationEditFromVacationViewController : UITableViewController<UIPickerViewDelegate,UIPickerViewDataSource,UITextFieldDelegate, UIAlertViewDelegate>{
