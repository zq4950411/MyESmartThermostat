...
@interface MyENext24HrsScheduleSubviewController(PrivateMethods)
...
@implementation MyENext24HrsScheduleSubviewController
@synthesize centerContainerView;
@synthesize applyButton;
@synthesize resetButton;
@synthesize useWeeklyButton = _useWeeklyButton;
...
- (void)viewDidUnload {
    ...
    _doughnutView = nil;
    [self setNext24hrsModel:nil];
    [self setNext24hrsModelCache:nil];
    _receivedData = nil;
    _periodEditingView = nil;
    _periodInforDoughnutView = nil;
    _holdEditingView = nil;
    _periodInforView = nil;
    HUD = nil;
