...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [heatingingNameLabel setTextAlignment:UITextAlignmentRight]; 
        ...
        [_coolingLabel setTextAlignment:UITextAlignmentLeft]; 
        ...
        [coolingNameLabel setTextAlignment:UITextAlignmentRight]; 
        ...
        [_holdLabel setTextAlignment:UITextAlignmentCenter]; 
